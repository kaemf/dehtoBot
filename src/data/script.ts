...
<b>Час заявки:</b> ${time_report}`,
    ...
    speakingClub: {
      ...
      about: `дякуємо, що цікавишся нашими шрах-клубами🥹
...
цьом♥️`,
      trialLesson: {
        text: `раді, що ти облав_ла пробне заняття!

це радше разове заняття на звичайному шпрах-клубі, щоб зрозуміти, чи пасує тобі такий формат☺️
